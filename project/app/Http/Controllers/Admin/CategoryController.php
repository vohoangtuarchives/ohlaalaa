...
use App\Exports\Categories\MainCategory;
...
class CategoryController extends Controller
{
    ...
    public function datatables()
    {
         ...
         return Datatables::of($datas)
                            ->editColumn('handling_fee', function(Category $data) {
                                return $data->handling_fee.'%';
                            })
    ...
    {
        $file_name = 'main-category_'.Carbon::now()->format('Y-m-d H:m:s').'.xlsx';
        return Excel::download(new MainCategory(), $file_name);
    }
}
