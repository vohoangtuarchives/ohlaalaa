...
class VendorController extends Controller
{
    ...
    {
        $user = Auth::user();
        $pending = VendorOrder::where('user_id','=',$user->id)->where('status','=','pending')->get()->groupBy('order_number');
        $processing = VendorOrder::where('user_id','=',$user->id)->where('status','=','processing')->get()->groupBy('order_number');
        $all = VendorOrder::where('user_id','=',$user->id)->get()->groupBy('order_number');
        return view('vendor.index',compact('user','pending','processing','all'));
    }
