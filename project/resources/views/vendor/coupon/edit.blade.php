...
@section('content')
            ...
            <div class="content-area">
              ...
              <div class="mr-breadcrumb">
                <div class="row">
                  <div class="col-lg-12">
                      <h4 class="heading">{{ __('Edit Coupon') }} <a class="add-btn" href="{{route('vendor-coupon-index')}}"><i class="fas fa-arrow-left"></i> {{ __('Back') }}</a></h4>
                      <ul class="links">
                        <li>
                          <a href="{{ route('vendor-dashboard') }}">{{ __('Dashboard') }} </a>
                        </li>
                        <li>
                          <a href="{{ route('vendor-coupon-index') }}">{{ __('Coupons') }}</a>
                        </li>
                        <li>
                          <a href="{{ route('vendor-coupon-edit',$data->id) }}">{{ __('Edit Coupon') }}</a>
                        </li>
                      </ul>
                  </div>
                </div>
