...
@section('content')
	...
	<div class="content-area">
		<div class="mr-breadcrumb">
			<div class="row">
				<div class="col-lg-12">
						<h4 class="heading"> {{ $langg->lang704 }} <a class="add-btn" onclick="history.back()"><i class="fas fa-arrow-left"></i> {{ $langg->lang550 }}</a></h4>
						<ul class="links">
							<li>
							  ...
							  <div class="gocover" style="background: url({{asset('assets/images/'.$gs->admin_loader)}}) no-repeat scroll center center rgba(45, 45, 45, 0.5);"></div>
								...
								@include('includes.vendor.form-both')
									...
									<div class="row">
										...
										<div class="col-lg-12">
											<input type="text" class="input-field" placeholder="{{ $langg->lang794 }}" name="sku" required="" value="{{ isset($data->sku) ? $data->sku : date("Y").Str::random(3).substr(time(), 6,8).Str::random(3) }}" readonly>
										...
										<div class="product-description">
											<div class="body-area">
													...
													<div class="col-lg-12">
                                                        ...
                                                        <div class="feature-tag-top-filds" id="feature-section">
                                                            <div class="feature-area">
                                                                <div class="row">
                                                                    <div class="col-lg-6">
                                                                        <input name="price" step="0.1" type="number" class="input-field"
                                                                            placeholder="unit price" required="" min="0" id="payment-unit-price" value="{{ $data->price }}">
                                                                    </div>
                                                                    <div class="col-lg-6">
                                                                        <input name="price_shopping_point" step="0.1" type="number" class="input-field"
                                                                            placeholder="shopping point" required="" min="0" id="payment-shopping-point" value="{{ $data->price_shopping_point }}">
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-lg-6">
                                                                        <input name="percent_price" step="0.01" type="number" class="input-field"
                                                                            placeholder="% unit price" required="" min="0" id="payment-percent-unit-price" value="{{ $data->percent_price }}">
                                                                    </div>
                                                                    <div class="col-lg-6">
                                                                        <input name="percent_shopping_point" step="0.01" type="number" class="input-field"
                                                                            placeholder="% shopping point" required="" min="0" id="payment-percent-shopping-point" value="{{ $data->percent_shopping_point }}">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <div class="left-area">
                                                            <h4 class="heading">Khối lượng*</h4>
                                                            <p class="sub-heading">gram</p>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-7">
                                                        <input name="weight" step="0.1" type="number" class="input-field"
...
$('.cropme').simpleCropper();
  ...
  $(document).ready(function() {
    ...
    let html = `<img src="{{ empty($data->photo) ? asset('assets/images/noimage.png') : (filter_var($data->photo, FILTER_VALIDATE_URL) ? $data->photo : $data->show_photo()) }}" alt="">`;
