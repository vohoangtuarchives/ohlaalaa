									...
									<div class="row">
										...
										<div class="col-lg-12">
											<input type="text" class="input-field" placeholder="{{ $langg->lang794 }}"
												name="sku" required=""
												value="{{date("Y").Str::random(3).substr(time(), 6,8).Str::random(3) }}" readonly>
						...
						<div class="product-description">
							<div class="body-area">
									...
									<div class="row">
										...
										<div class="col-lg-12">
											{{-- <input name="price" step="0.1" type="number" class="input-field" id="product-price"
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <input name="price" step="0.1" type="number" class="input-field"
                                                                placeholder="unit price" required="" min="0" id="payment-unit-price">
                                                        </div>
                                                        <div class="col-lg-6">
                                                            <input name="price_shopping_point" step="0.1" type="number" class="input-field"
                                                                placeholder="shopping point" required="" min="0" id="payment-shopping-point">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <input name="percent_price" step="0.01" type="number" class="input-field"
                                                                placeholder="% unit price" required="" min="0" id="payment-percent-unit-price">
                                                        </div>
                                                        <div class="col-lg-6">
                                                            <input name="percent_shopping_point" step="0.01" type="number" class="input-field"
                                                                placeholder="% shopping point" required="" min="0" id="payment-percent-shopping-point">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="row">
										<div class="col-lg-12">
											<div class="left-area">
												<h4 class="heading">{{ $langg->lang861 }}*</h4>
												<p class="sub-heading">{{ $langg->lang862 }}</p>
											</div>
										</div>
										<div class="col-lg-12">
											<input name="weight" step="0.1" type="number" class="input-field"
												placeholder="{{ $langg->lang666 }}" min="0" required>
										</div>
									</div>
