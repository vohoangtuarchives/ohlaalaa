															...
															<div class="product-details">
																<div class="content">
																	...
																	<span class="cart-product-info">
																		...
																		<span id="prct{{$product['item']['id'].$product['size'].$product['color'].str_replace(str_split(' ,'),'',$product['values'])}}">{{ App\Models\Product::convertPrice($product['item_price']) }}</span>
																	</span>
																</div>
																...
																<a href="{{ route('front.product', $product['item']['slug']) }}" class="product-image">
																	...
																	<img src="{{ $product['item']['photo'] ?
                                                                        (filter_var($product['item']['photo'], FILTER_VALIDATE_URL) ?
                                                                            $product['item']['photo'] :
                                                                            $htd_photo->show_photo($product['item']['photo'], 'products') )
