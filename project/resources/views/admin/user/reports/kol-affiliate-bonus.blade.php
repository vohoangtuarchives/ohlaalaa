                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="mr-table allproduct">
                                        ...
                                        <input type="text" class="form-control-sm" name="from_date" id="from" placeholder="{{ __('Select a date') }}" value="{{ $gs->kol_aff_from }}" autocomplete="off" style="width: 100px;">
                                        <label for="include-renew">{{ __('Include Renew') }}: </label>
...
<script type="text/javascript">
    ...
    var table = $('#geniustable').DataTable({
        ...
        serverSide: true,
        pageLength: 50,
        ajax: '{{ route('admin-user-report-kol-affiliatebonus-datatables',[$gs->kol_aff_from, 0]) }}',
        columns: [
                ...
                { data: 'kolaff_calculated', name: 'kolaff_calculated'},
                ],
        language : {
