    ...
    <div class="content-area">
                        ...
                        <div class="order-table-wrap">
                                    ...
                                    <div class="special-box">
                                        ...
                                        <div class="table-responsive-sm">
                                            <table class="table">
                                                ...
                                                <tr>
                                                    <th class="45%" width="45%">{{ __('Products Amount') }}</th>
                                                    <td width="10%">:</td>
                                                    <td class="45%" width="45%">{{$order->currency_sign}}{{number_format($order->products_amount)}}</td>
                                                </tr>
                                                <tr>
                                                    <th class="45%" width="45%">{{ __('Shipping Cost') }}</th>
                                                    <td width="10%">:</td>
                                                    <td class="45%" width="45%">{{$order->currency_sign}}{{number_format($order->shipping_cost)}}</td>
                                                </tr>
                                                @if ($order->tax > 0)
                                                    <tr>
                                                        <th width="45%">{{ __('VAT') }}</th>
                                                        <td width="10%">:</td>
                                                        <td width="45%">{{$order->currency_sign}}{{number_format($order->tax / 100.0 * $order->products_amount)}}</td>
                                                    </tr>
                                                @endif
                                                <tr>
                                                    <th width="45%">{{ __('Company Discount') }}</th>
                                                    <td width="10%">:</td>
                                                    <td width="45%">{{$order->currency_sign}}{{number_format($order->coupon_discount)}}</td>
                                                </tr>
                                                <tr>
                                                    <th width="45%">{{ __('Shop Discount') }}</th>
                                                    <td width="10%">:</td>
                                                    <td width="45%">{{$order->currency_sign}}{{number_format($order->vendor_discount_amount)}}</td>
                                                </tr>
                                                <tr>
                                                    <th width="45%">{{ __('Price After Discount') }}</th>
                                                    <td width="10%">:</td>
                                                    <td width="45%">{{$order->currency_sign}}{{ number_format(round($order->pay_amount1 * $order->currency_value , 2)) }}</td>
                                                </tr>
                                                <tr>
                                                    <th width="45%">{{ __('Shopping Point') }}</th>
                                                    <td width="10%">:</td>
                                                    <td width="45%">{{$order->currency_sign}}{{ number_format(round($order->shopping_point_amount * $order->currency_value , 2)) }}</td>
                                                </tr>
                                                <tr>
                                                    <th width="45%">{{ __('Payment Amount after SP & Discount') }}</th>
                                                    <td width="10%">:</td>
                                                    <td width="45%">{{$order->currency_sign}}{{ number_format(round($order->pay_amount2 * $order->currency_value , 2)) }}</td>
                                                </tr>
                                                <tr>
                            ...
                            <tr>
                                ...
                                <td width="45%">{{ $order->currency_sign }}{{ number_format($order->coupon_discount) }}</td>
                                @else
                                <td width="45%">{{ number_format($order->coupon_discount) }}{{ $order->currency_sign }}</td>
                                @endif
                            </tr>
                            @endif
                        ...
                        <tr>
                            ...
                            @else
                                ...
                                <tr>
                                    ...
                                    <th width="10%">:</th>
                                    <td width="45%">{{$order->currency_sign}}{{ number_format($order->shipping_cost) }}</td>
                                </tr>
                            ...
                            <div class="row">
                              ...
                              <a href="javascript:;" data-toggle="modal" data-target="#confirm-delete" class="btn btn-info product-btn" id="license" style="padding: 5px 12px;"><i class="fa fa-eye"></i> {{ __('View License') }}</a>
                                                @endif
                                                <br>
                                                {{ __('Weight') }}: {{ number_format($product['item']['weight']) }} {{ __('gram') }}
                                            </td>
                                            <td>
                                                @if($product['size'])
                                               <p>
