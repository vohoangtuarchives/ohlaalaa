                            ...
                            <div class="table-responsive">
                                <table id="example2" class="table table-hover dt-responsive" cellspacing="0"
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="no-border">
                                            <td colspan="2"></td>
                                            <td colspan="2"><strong>{{ __('TAX') }}({{$order->currency_sign}})</strong></td>
                                            @php
                                        ...
                                        @endphp
                                            ...
                                            <tr class="no-border">
                                                <td colspan="2"></td>
                                                <td colspan="2"><strong>{{ __('Shipping Cost') }} ({{ $sp->shop()->first()->shop_name }})</strong></td>
                                        ...
                                        <tr class="no-border">
                                            <td colspan="2"></td>
                                            <td colspan="2"><strong>{{ __('Company Discount') }}</strong></td>
                                        ...
                                        <tr class="no-border">
                                            <td colspan="2"></td>
                                            <td colspan="2"><strong>{{ __('Price After Discount') }}</strong></td>
                                        ...
                                        <tr class="final-border">
                                            <td colspan="2"></td>
                                            <td colspan="2"><strong>{{ __('Payment Amount after SP & Discount') }}</strong></td>
