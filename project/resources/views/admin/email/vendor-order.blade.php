...
<body>
    <div class="content-area">
        <div class="mr-breadcrumb">
            <div class="row">
                <div class="col-lg-12">
                    <h4 class="heading">Hello, {{ $user->name }}!</h4>

                    Customer has placed your product in an order. <br>
                    Please find it in the following details.
                </div>
            </div>
        </div>
                                ...
                                <div class="table-responsive">
                                    ...
                                    @endif
                                        ...
                                        <tfoot>
                                            ...
                                            <tr>
                                                <td colspan="2"></td>
                                                <td colspan="2">{{ $langg->lang880 }}</td>
                                                <td>{{$order->currency_sign}}{{ number_format(round(($shopping_point_amount), 2)) }}
                                                </td>
                                            </tr>
                                            <tr>
                                                <td colspan="2"></td>
                                                <td colspan="2">Payment Amount After SP & Discount</td>
