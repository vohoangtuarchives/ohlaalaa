            ...
            <div class="login-area signup-area">
              ...
              <div class="login-form signup-form">
                ...
                <form class="mregisterform" action="{{route('user-register-submit')}}" method="POST">
                  ...
                  <div class="form-input">
                    <input type="text" class="User Name" name="referral_code" value="{{ isset($_GET["ref"]) ? $_GET["ref"] : "" }}" placeholder="Referral Code" readonly>
                ...
                <br>@include('includes.admin.form-login')
              </div>
            </div>
          </div>
        </div>
