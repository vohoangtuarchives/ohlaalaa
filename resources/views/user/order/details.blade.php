                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <address>
                                            ...
                                            {{ $langg->lang291 }} {{$order->customer_address}}, {{$order->user->province->name}}<br>
                                ...
                                <table class="table table-bordered veiw-details-table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @php
                                                    $shipping = DB::table('order_consumer_shipping_costs')
                                                    ->where('order_id','=',$order->id)
                                                    ->where('shop_id','=',$product['item']['user_id'])
                                                    ->first();
                                                @endphp
                                                {{ $shipping == null ? '' : $shipping->shipping_partner_code }}
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
