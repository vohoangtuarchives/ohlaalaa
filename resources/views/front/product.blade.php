    ...
    <div class="col-lg-{{ $gs->reg_vendor == 1 ? '9' : '12' }}">
        <div class="row">
          ...
          <div class="xzoom-container">
            ...
            @if ($productt->price_shopping_point > 0)
            <div class="product-price">
                <p class="title">SP : </p>
                <p class="price"><span id="sizeprice">+ {{ number_format($productt->price_shopping_point) }}</span>
                    <small>{{ $productt->percent_shopping_point }}%</small></p>
            </div>
            @endif
           ...
           @if( $productt->user_id  != 0)
              @if(isset($productt->user))
                ...
                <span >
                    ...
                    {{ isset($productt->user->province) ? $productt->user->province->name : '' }}
                  </span>
