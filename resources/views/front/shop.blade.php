            ...
            <div class="right-area" id="app">
               ...
               <div class="categori-item-area">
                 <div class="row" id="ajaxContent">
                    ...
                    @include('includes.shop.filtered-shop')
                    @if (count($shops) == 0)
                        <div class="col-lg-12">
                 ...
                 <div id="ajaxLoader" class="auto-load text-center">
                    <svg version="1.1" id="L9" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                        x="0px" y="0px" viewBox="0 0 400 100" enable-background="new 0 0 0 0" xml:space="preserve">
    ...
    $(document).ready(function() {
        ...
        function infinteLoadMore(page, sort = '', method = 'get', position = 0 ) {
            ...
            $.ajax({
                ...
                url:"{{ route('front.shop-list', [Request::route('search')])}}"+  "?" + search_location + "&page=" + page + sort,
                datatype: "html",
                type: method,
                beforeSend: function () {
