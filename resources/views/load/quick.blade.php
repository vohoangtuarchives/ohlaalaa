...
<div class="xzoom-container">
    ...
    <img class="quick-zoom" id="xzoom-magnific1" src="{{filter_var($product->photo, FILTER_VALIDATE_URL) ?$product->photo:$product->show_photo()}}" xoriginal="{{filter_var($product->photo, FILTER_VALIDATE_URL) ?$product->photo: $product->show_photo()}}" />
    <div class="xzoom-thumbs">
      ...
      <div class="quick-all-slider">
        ...
        <a href="{{filter_var($product->photo, FILTER_VALIDATE_URL) ?$product->photo: $product->show_photo()}}">
            <img class="quick-zoom-gallery" width="80" src="{{filter_var($product->photo, FILTER_VALIDATE_URL) ?$product->photo: $product->show_photo()}}" title="The description goes here">
        </a>
