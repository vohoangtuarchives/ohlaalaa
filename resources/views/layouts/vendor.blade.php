	...
	<body>
		<div class="page">
			<div class="page-main">
							...
							<div class="right-eliment">
								<ul class="list">
                                    ...
                                    <li class="bell-area">
										...
										<div class="dropdown-menu">
											<div class="dropdownmenu-wrapper" data-href="{{ route('vendor-order-notf-wallet') }}" id="order-notf-wallet">
										</div>
										</div>
									</li>
              ...
              <img src="{{ Auth::user()->show_photo() }}" alt="">
              @endif
											</div>
										</a>
										<div class="dropdown-menu">
				...
				<div class="wrapper">
					...
					<nav id="sidebar" class="nav-sidebar">
						<ul class="list-unstyled components" id="accordion">
                            ...
                            <li>
								<a href="{{ route('vendor-coupon-index') }}" class="wave-effect "><i class="fa fa-gift mr-2"></i>Đặt phiếu giảm giá</a>
							</li>
