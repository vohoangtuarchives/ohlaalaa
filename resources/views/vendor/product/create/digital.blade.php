										...
										<div class="col-lg-12">
                                            <div class="feature-tag-top-filds" id="feature-section">
                                                <div class="feature-area">
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <input name="price" step="any" type="number" class="input-field"
                                                                placeholder="unit price" required="" min="0" id="payment-unit-price">
                                                        </div>
                                                        <div class="col-lg-6">
                                                            <input name="price_shopping_point" step="any" type="number" class="input-field"
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <input name="percent_price" step="any" type="number" class="input-field"
                                                                placeholder="% unit price" required="" min="0" id="payment-percent-unit-price">
                                                        </div>
                                                        <div class="col-lg-6">
                                                            <input name="percent_shopping_point" step="any" type="number" class="input-field"
