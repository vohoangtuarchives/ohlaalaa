<li>
    ...
    <li>
        <a href="#menureport" class="accordion-toggle wave-effect" data-toggle="collapse" aria-expanded="false">
            <i class="icofont-cart"></i>{{ __('Reports') }}
        </a>
        <ul class="collapse list-unstyled" id="menureport" data-parent="#accordion">
            {{-- <li>
                <a href="{{route('admin-order-ordersreport')}}">{{ __('Tracking Orders') }}</a>
            </li> --}}
            <li>
                <a href="{{route('admin-order-report-kol-consumerbonus-2w')}}">{{ __('KOL Bonus') }}</a>
            </li>
            <li>
                <a href="{{route('admin-order-report-merchant-payment')}}">{{ __('Merchant Payment Report') }}</a>
            </li>
            <li>
                <a href="{{route('admin-order-report-sale-full')}}">{{ __('Sale Full Report') }}</a>
            </li>
            <li>
                <a href="{{route('admin-order-report-salefull-detail')}}">{{ __('Sale Full Report Detail') }}</a>
            </li>
            <li>
                <a href="{{route('admin-vendor-report-merchant-approval')}}">{{ __('1. Merchant Approval') }}</a>
            </li>
            <li>
                <a href="{{route('admin-vendor-report-merchant-approval-summaries')}}">{{ __('1.1 Merchant Approval Summaries') }}</a>
            </li>
            <li>
                <a href="{{route('admin-order-report-merchant-performance')}}">{{ __('2. Merchant Performance') }}</a>
            </li>
            <li>
                <a href="{{route('admin-order-report-merchant-performance-summaries-top10byshop')}}">{{ __('2.1 Merchant Performance Summaries - Top 10 Sales By Shop') }}</a>
            </li>
            <li>
                <a href="{{route('admin-order-report-merchant-performance-summaries-top10byproduct')}}">{{ __('2.2 Merchant Performance Summaries - Top 10 Sales By Product') }}</a>
            </li>
            <li>
                <a href="{{route('admin-order-report-merchant-performance-summaries-top10byproductcategory')}}">{{ __('2.3 Merchant Performance Summaries - Top 10 Sales By Product category') }}</a>
            </li>
            <li>
                <a href="{{route('admin-order-report-merchant-performance-summaries-top10byprovince')}}">{{ __('2.3 Merchant Performance Summaries - Top 10 Sales By City') }}</a>
            </li>
            <li>
                <a href="{{route('admin-user-report-sale-report')}}">{{ __('3. Sales Report - Customer') }}</a>
            </li>
            <li>
                <a href="{{route('admin-user-report-sale-report-summaries-top10spendingamount')}}">{{ __('3.1 Sales Report - Summaries Top Spending Customer by Total Purchase Amount') }}</a>
            </li>
            <li>
                <a href="{{route('admin-user-report-sale-report-summaries-top10spendingorder')}}">{{ __('3.2 Sales Report - Summaries Top Spending Customer by Total Purchase Order') }}</a>
            </li>
            <li>
                <a href="{{route('admin-user-report-sale-report-summaries-top10spearningbyaffiliate')}}">{{ __('3.3 Sales Report - Summaries Top SP Earning By Affiliate Bonus') }}</a>
            </li>
            <li>
                <a href="{{route('admin-user-report-sale-report-summaries-top10rpearningbymerchantbonus')}}">{{ __('3.4 Sales Report - Summaries Top RP Earning By Merchant Bonus') }}</a>
            </li>
            <li>
  ...
  <li>
        <a href="#externalreport" class="accordion-toggle wave-effect" data-toggle="collapse" aria-expanded="false">
            <i class="icofont-cart"></i>{{ __('External Report') }}
        </a>
        <ul class="collapse list-unstyled" id="externalreport" data-parent="#accordion">
            <li>
    ...
    <li>
        <a href="#menukol" class="accordion-toggle wave-effect" data-toggle="collapse" aria-expanded="false">
            <i class="icofont-cart"></i>{{ __('KOL Bonus') }}
        </a>
        <ul class="collapse list-unstyled" id="menukol" data-parent="#accordion">
            <li>
                <a href="{{route('admin-order-report-kol-consumerbonus')}}">{{ __('KOL Consumer Bonus') }}</a>
            </li>
            <li>
    ...
    <li>
        ...
        <ul class="collapse list-unstyled" id="menu3" data-parent="#accordion">
            ...
            <li>
                <a href="{{ route('admin-user-member-package') }}"><span>{{ __('Member Package Register') }}</span></a>
            </li>
            <li>
    ...
    <li>
        ...
        <ul class="collapse list-unstyled" id="vendor" data-parent="#accordion">
            ...
            <li>
                <a href="{{ route('admin-coupon-vendor-index') }}"><span>{{ __('Set Coupons') }}</span></a>
            </li>
        </ul>
    </li>
    ...
    <li>
        ...
        <ul class="collapse list-unstyled" id="general" data-parent="#accordion">
            ...
            <li>
                <a href="{{ route('admin-gs-affilate') }}"><span>{{ __('Bonus Configuration') }}</span></a>
            </li>
            <li>
                <a href="{{ route('admin-gs-kol') }}"><span>{{ __('KOL Bonus Configuration') }}</span></a>
            </li>
            <li>
                <a href="{{ route('admin-affiliatelevel-index') }}"><span>{{ __('Affiliate Bonus Rate') }}</span></a>
            </li>
            <li>
                <a href="{{ route('admin-packageconfig-index') }}"><span>{{ __('Member Packages') }}</span></a>
            </li>
            <li>
    ...
    <li>
        ...
        <ul class="collapse list-unstyled" id="emails" data-parent="#accordion">
            ...
            <li><a href="{{route('admin-send-mail')}}"><span>{{ __('Send Mail') }}</span></a></li>
        </ul>
    </li>
    <li>
    ...
    <li>
        ...
        {{-- <li>
            <a href="{{ route('admin-import-migration-complete-order-update') }}" class=" wave-effect"><i class="fas fa-sync"></i>{{ __('Complete Migrations Order') }}</a>
        </li> --}}
        <li>
