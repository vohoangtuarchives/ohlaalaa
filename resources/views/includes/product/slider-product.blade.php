<div class="item">
    ...
    @endif
        <div class="item-img">
            ...
            {{-- <img class="front-index-featured-img img-fluid" src="{{ $prod->thumbnail ? asset('assets/images/thumbnails/'.$prod->thumbnail):asset('assets/images/noimage.png') }}" alt=""> --}}
            <img class="front-index-featured-img img-fluid" src="{{ $prod->show_thumbnail() }}" alt="">
        </div>
    @if (isMobileDevice())
        <a href="{{ route('front.product', $prod->slug) }}">
    @endif
