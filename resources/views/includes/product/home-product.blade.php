    ...
    <div class="item">
        ...
        @endif
            <div class="item-img">
                ...
                {{-- <img class="img-fluid front-index-featured-img" src="{{ $prod->thumbnail ? asset('assets/images/thumbnails/'.$prod->thumbnail):asset('assets/images/noimage.png') }}" alt=""> --}}
                <img class="img-fluid front-index-featured-img" src="{{ $prod->show_thumbnail() }}" alt="">
            </div>
        @if (isMobileDevice())
            <a href="{{ route('front.product', $prod->slug) }}">
        @endif
