                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                        ...
                                        <ul class="links">
                                            ...
                                            <li>
                                                <a href="{{route('admin-order-report-merchant-performance-summaries-top10byshop')}}">{{ __('Merchant Perfromance Summaries - Top 10 By Shop') }}</a>
                                            </li>
                                        </ul>
                                </div>
                            </div>
...
<script type="text/javascript">
    ...
    var table = $('#geniustable').DataTable({
        ...
        serverSide: true,
        pageLength: 10,
        ajax: '{{ route('admin-order-report-merchant-performance-summaries-top10byshop-datatables',[\Carbon\Carbon::now()->format('Y-m-d'),\Carbon\Carbon::now()->format('Y-m-d')]) }}',
        columns: [
    ...
    $("#add-find" ).on('click' , function(e){
        ...
        var url = mainurl+'/admin/orders/reports/merchantperformance/summaries/top10byshop/datatables/'+sf+'/'+st;
        console.log('url',url);
    ...
    $("#export-excel" ).on('click' , function(e){
        ...
        var st = get_date_string($('#to').val());
        // var status = $('#status').val();
        var url = mainurl+'/admin/orders/reports/merchantperformance/summaries/top10byshop/export/'+sf+'/'+st;
