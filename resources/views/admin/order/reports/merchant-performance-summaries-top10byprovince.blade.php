                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                        ...
                                        <ul class="links">
                                            ...
                                            <li>
                                                <a href="{{route('admin-order-report-merchant-performance-summaries-top10byprovince')}}">{{ __('Merchant Perfromance Summaries - Top 10 By City') }}</a>
                                            </li>
                                        </ul>
                                </div>
                            </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="mr-table allproduct">
                                        ...
                                        <table id="geniustable" class="table table-hover dt-responsive" cellspacing="0" width="100%">
                                            <thead>
                                                <tr>
                                                    <th style="width:300px">{{ __('City') }}</th>
...
<script type="text/javascript">
    ...
    var table = $('#geniustable').DataTable({
        ...
        serverSide: true,
        pageLength: 10,
        ajax: '{{ route('admin-order-report-merchant-performance-summaries-top10byprovince-datatables',[\Carbon\Carbon::now()->format('Y-m-d'),\Carbon\Carbon::now()->format('Y-m-d')]) }}',
        columns: [
                { data: 'city', name: 'city'},
    ...
    $("#add-find" ).on('click' , function(e){
        ...
        var url = mainurl+'/admin/orders/reports/merchantperformance/summaries/top10byprovince/datatables/'+sf+'/'+st;
        console.log('url',url);
    ...
    $("#export-excel" ).on('click' , function(e){
        ...
        var st = get_date_string($('#to').val());
        // var status = $('#status').val();
        var url = mainurl+'/admin/orders/reports/merchantperformance/summaries/top10byprovince/export/'+sf+'/'+st;
