                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="mr-table allproduct">
                                        ...
                                        <input type="text" class="form-control-sm" name="from_date" id="from" placeholder="{{ __('Select a date') }}" value="{{ $gs->kol_con_from }}" autocomplete="off" style="width: 100px;">
...
<script type="text/javascript">
    ...
    var table = $('#geniustable').DataTable({
        ...
        serverSide: true,
        pageLength: 50,
        ajax: '{{ route('admin-order-report-kol-consumerbonus-datatables',[$gs->kol_con_from]) }}',
        columns: [
    ...
    $("#export-excel" ).on('click' , function(e){
        var sf = get_date_string($('#from').val());
        var url = mainurl+'/admin/orders/reports/kolconsumerbonus/export/'+sf;
