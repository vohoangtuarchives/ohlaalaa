...
<script type="text/javascript">
    ...
    var table = $('#geniustable').DataTable({
        ...
        serverSide: true,
        pageLength: 50,
        ajax: '{{ route('admin-order-datatables-report-sale-full',['completed', 'all', \Carbon\Carbon::now()->format('Y-m-d'),\Carbon\Carbon::now()->format('Y-m-d')]) }}',
        columns: [
    ...
    $("#add-find" ).on('click' , function(e){
        ...
        var url = mainurl+'/admin/orders/datatablesv2/report/salefull/'+status+'/'+iscollected+'/'+sf+'/'+st;
        console.log('url',url);
    ...
    $("#export-excel" ).on('click' , function(e){
        ...
        var status = $('#status').val();
        var iscollected = $('#is-collected').val();
        var url = mainurl+'/admin/orders/export/report/salefull/'+status+'/'+iscollected+'/'+sf+'/'+st;
