                    ...
                    <div class="product-description">
                      ...
                      <form id="geniusformdata" action="{{route('admin-subscription-update',$data->id)}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="number" class="input-field" name="price" placeholder="{{ __("Enter Subscription Cost") }}" required="" value="{{ $data->price }}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="number" class="input-field" name="days" placeholder="{{ __("Enter Subscription Days") }}" required="" value="{{ $data->days }}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                              <div class="left-area">
                                  <h4 class="heading">{{ __("Default") }}*</h4>
                              </div>
                            </div>
                            <div class="col-lg-7">
                                <select name="is_default" required="">
                                    <option value="0" {{ $data->is_default == 0 ? "selected" : "" }}>{{ __("No") }}</option>
                                    <option value="1" {{ $data->is_default == 1 ? "selected" : "" }}>{{ __("Yes") }}</option>
                                </select>
                            </div>
                          </div>
                          ...
                          <div class="row">
                            ...
                            <div class="col-lg-7">
                                <select name="type" required="">
                                    <option value="0" {{ $data->type == 0 ? "selected" : "" }}>{{ __("Free") }}</option>
                                    <option value="1" {{ $data->type == 1 ? "selected" : "" }}>{{ __("Pricing") }}</option>
                                </select>
                            </div>
                          </div>
