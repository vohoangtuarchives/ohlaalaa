...
{{-- DATA TABLE --}}
    ...
    <script type="text/javascript">
		...
		var table = $('#geniustable').DataTable({
               ...
               columns: [
                        ...
                        { data: 'approved_at', searchable: false},
    ...
    $("#add-find" ).on('click' , function(e){
        ...
        table.destroy();
        var url = mainurl+'/admin/verificatons/datatables/'+status+'/'+sf+'/'+st+'/'+email;
...
<script type="text/javascript">
    ...
    $("#export-excel" ).on('click' , function(e){
        ...
        var status = $('#status').val();
        var url = mainurl+'/admin/verificatons/export/'+status+'/'+sf+'/'+st;
