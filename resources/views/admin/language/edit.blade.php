...
@section('content')
                     ...
                     <hr>
                      ...
                      <hr>
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                              <div class="left-area">
                                  <h4 class="heading">Chat With seller *</h4>
                                  <p class="sub-heading">(In Any Language)</p>
                              </div>
                            </div>
                            <div class="col-lg-7">
                              <input type="text" class="input-field" name="lang889"
                                placeholder="Chat With seller" required=""
                                value="{{ isset($lang->lang889) ? $lang->lang889 : 'Chat With seller' }}">
                            </div>
                          </div>
                      ...
                      <hr>
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                              <div class="left-area">
                                <h4 class="heading">Total Product Price *</h4>
                                <p class="sub-heading">(In Any Language)</p>
                              </div>
                            </div>
                            <div class="col-lg-7">
                              <input type="text" class="input-field" name="lang902" placeholder="Total Product Price" required=""
                              value="{{ isset($lang->lang902) ? $lang->lang902 : 'Total Product Price' }}">
                            </div>
                          </div>
                          ...
                          <div class="row">
                            <div class="col-lg-4">
                              <div class="left-area">
                                <h4 class="heading">Product Shopping Point *</h4>
                                <p class="sub-heading">(In Any Language)</p>
                              </div>
                            </div>
                            <div class="col-lg-7">
                              <input type="text" class="input-field" name="lang903" placeholder="Product Shopping Point" required=""
                              value="{{ isset($lang->lang903) ? $lang->lang903 : 'Product Shopping Point' }}">
                            </div>
                          </div>
                          ...
                          <div class="row">
                            <div class="col-lg-4">
                              <div class="left-area">
                                <h4 class="heading">Total Shopping Point Use *</h4>
                                <p class="sub-heading">(In Any Language)</p>
                              </div>
                            </div>
                            <div class="col-lg-7">
                              <input type="text" class="input-field" name="lang904" placeholder="Total Shopping Point Use" required=""
                              value="{{ isset($lang->lang904) ? $lang->lang904 : 'Total Shopping Point Use' }}">
                            </div>
                          </div>
                          ...
                          <div class="row">
                            <div class="col-lg-4">
                              <div class="left-area">
                                <h4 class="heading">Total Shop Discount *</h4>
                                <p class="sub-heading">(In Any Language)</p>
                              </div>
                            </div>
                            <div class="col-lg-7">
                              <input type="text" class="input-field" name="lang905" placeholder="Total Shop Discount" required=""
                              value="{{ isset($lang->lang905) ? $lang->lang905 : 'Total Shop Discount' }}">
                            </div>
                          </div>
                      ...
                      <hr>
                       ...
                       <div class="row">
                        ...
                        <div class="row">
                          <div class="col-lg-4">
                            <div class="left-area">
                                <h4 class="heading">Company Discount *</h4>
                                <p class="sub-heading">(In Any Language)</p>
                            </div>
                          </div>
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang145" placeholder="Company Discount" required="" value="{{ $lang->lang145 }}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                              <div class="left-area">
                                  <h4 class="heading">Viettel Post *</h4>
                                  <p class="sub-heading">(In Any Language)</p>
                              </div>
                            </div>
                            <div class="col-lg-7">
                              <input type="text" class="input-field" name="lang891"
                                placeholder="Viettel Post" required=""
                                value="{{ isset($lang->lang891) ? $lang->lang891 : 'Viettel Post' }}">
                            </div>
                          </div>
                          ...
                          <div class="row">
                            <div class="col-lg-4">
                              <div class="left-area">
                                  <h4 class="heading">Negotiate *</h4>
                                  <p class="sub-heading">(In Any Language)</p>
                              </div>
                            </div>
                            <div class="col-lg-7">
                              <input type="text" class="input-field" name="lang892"
                                placeholder="Negotiate" required=""
                                value="{{ isset($lang->lang892) ? $lang->lang892 : 'Negotiate' }}">
                            </div>
                          </div>
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                              <div class="left-area">
                                  <h4 class="heading">Select Province *</h4>
                                  <p class="sub-heading">(In Any Language)</p>
                              </div>
                            </div>
                            <div class="col-lg-7">
                              <input type="text" class="input-field" name="lang893"
                                placeholder="Select Province" required=""
                                value="{{ isset($lang->lang893) ? $lang->lang893 : 'Select Province' }}">
                            </div>
                          </div>
                          ...
                          <div class="row">
                            ...
                            <div class="col-lg-7">
                              <input type="text" class="input-field" name="lang894"
                                placeholder="Select District" required=""
                                value="{{ isset($lang->lang894) ? $lang->lang894 : 'Select District' }}">
                            </div>
                          </div>
                          ...
                          <div class="row">
                            <div class="col-lg-4">
                              <div class="left-area">
                                  <h4 class="heading">Select Ward *</h4>
                                  <p class="sub-heading">(In Any Language)</p>
                              </div>
                            </div>
                            <div class="col-lg-7">
                              <input type="text" class="input-field" name="lang895"
                                placeholder="Select Ward" required=""
                                value="{{ isset($lang->lang895) ? $lang->lang895 : 'Select Ward' }}">
                            </div>
                          </div>
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang167" placeholder="Transaction ID#" required="" value="{{ $lang->lang167 }}">
                                                  ...
                                                  <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                      <input type="text" class="input-field" name="lang896"
                                                        placeholder="Shopping Point" required=""
                                                        value="{{ isset($lang->lang896) ? $lang->lang896 : 'Shopping Point' }}">
                                                    </div>
                                                  </div>
                                                  ...
                                                  <div class="row">
                                                    <div class="col-lg-4">
                                                      <div class="left-area">
                                                          <h4 class="heading">Total Shopping Point *</h4>
                                                          <p class="sub-heading">(In Any Language)</p>
                                                      </div>
                                                    </div>
                                                    <div class="col-lg-7">
                                                      <input type="text" class="input-field" name="lang897"
                                                        placeholder="Total Shopping Point" required=""
                                                        value="{{ isset($lang->lang897) ? $lang->lang897 : 'Total Shopping Point' }}">
                                                    </div>
                                                  </div>
                      ...
                      <div class="row">
                        <div class="col-lg-4">
                          <div class="left-area">
                            <h4 class="heading">Delivery partner *</h4>
                            <p class="sub-heading">(In Any Language)</p>
                          </div>
                        </div>
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang813" placeholder="Delivery partner" required=""
                          value="{{ isset($lang->lang813) ? $lang->lang813 : 'Delivery partner' }}">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang814" placeholder="Negotiate" required=""
                          value="{{ isset($lang->lang814) ? $lang->lang814 : 'Negotiate' }}">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang815" placeholder="Shipping Cost" required=""
                          value="{{ isset($lang->lang815) ? $lang->lang815 : 'Shipping Cost' }}">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang906" placeholder="Final Price" required=""
                          value="{{ isset($lang->lang906) ? $lang->lang906 : 'Final Price' }}">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        <div class="col-lg-4">
                          <div class="left-area">
                            <h4 class="heading">Final Price before SP *</h4>
                            <p class="sub-heading">(In Any Language)</p>
                          </div>
                        </div>
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang816" placeholder="Final Price before SP" required=""
                          value="{{ isset($lang->lang816) ? $lang->lang816 : 'Final Price before SP' }}">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        <div class="col-lg-4">
                          <div class="left-area">
                            <h4 class="heading">Final Price after SP *</h4>
                            <p class="sub-heading">(In Any Language)</p>
                          </div>
                        </div>
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang817" placeholder="Final Price after SP" required=""
                          value="{{ isset($lang->lang817) ? $lang->lang817 : 'Final Price after SP' }}">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        <div class="col-lg-4">
                          <div class="left-area">
                            <h4 class="heading">Shopping Point Use *</h4>
                            <p class="sub-heading">(In Any Language)</p>
                          </div>
                        </div>
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang818" placeholder="Shopping Point Use" required=""
                          value="{{ isset($lang->lang818) ? $lang->lang818 : 'Shopping Point Use' }}">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        <div class="col-lg-4">
                          <div class="left-area">
                            <h4 class="heading">Balance *</h4>
                            <p class="sub-heading">(In Any Language)</p>
                          </div>
                        </div>
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang819" placeholder="Balance" required=""
                          value="{{ isset($lang->lang819) ? $lang->lang819 : 'Balance' }}">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        <div class="col-lg-4">
                          <div class="left-area">
                            <h4 class="heading">In Use *</h4>
                            <p class="sub-heading">(In Any Language)</p>
                          </div>
                        </div>
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang820" placeholder="In Use" required=""
                          value="{{ isset($lang->lang820) ? $lang->lang820 : 'In Use' }}">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        <div class="col-lg-4">
                          <div class="left-area">
                            <h4 class="heading">Remain *</h4>
                            <p class="sub-heading">(In Any Language)</p>
                          </div>
                        </div>
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang821" placeholder="Remain" required=""
                          value="{{ isset($lang->lang821) ? $lang->lang821 : 'Remain' }}">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        <div class="col-lg-4">
                          <div class="left-area">
                            <h4 class="heading">Use SP *</h4>
                            <p class="sub-heading">(In Any Language)</p>
                          </div>
                        </div>
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang822" placeholder="Use SP" required=""
                          value="{{ isset($lang->lang822) ? $lang->lang822 : 'Use SP' }}">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang823" placeholder="Amount" required=""
                          value="{{ isset($lang->lang823) ? $lang->lang823 : 'Amount' }}">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang898" placeholder="Remain" required=""
                          value="{{ isset($lang->lang898) ? $lang->lang898 : 'Remain' }}">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        <div class="col-lg-4">
                          <div class="left-area">
                            <h4 class="heading">Sub Amount *</h4>
                            <p class="sub-heading">(In Any Language)</p>
                          </div>
                        </div>
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang899" placeholder="Sub Amount" required=""
                          value="{{ isset($lang->lang899) ? $lang->lang899 : 'Sub Amount' }}">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        <div class="col-lg-4">
                          <div class="left-area">
                            <h4 class="heading">Shop Coupon *</h4>
                            <p class="sub-heading">(In Any Language)</p>
                          </div>
                        </div>
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang900" placeholder="Shop Coupon" required=""
                          value="{{ isset($lang->lang900) ? $lang->lang900 : 'Shop Coupon' }}">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang907" placeholder="APPLY" required=""
                          value="{{ isset($lang->lang907) ? $lang->lang907 : 'APPLY' }}">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        <div class="col-lg-4">
                          <div class="left-area">
                            <h4 class="heading">Final Amount *</h4>
                            <p class="sub-heading">(In Any Language)</p>
                          </div>
                        </div>
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang901" placeholder="Final Amount" required=""
                          value="{{ isset($lang->lang901) ? $lang->lang901 : 'Final Amount' }}">
                        </div>
                      </div>
                     ...
                     <hr>
                      ...
                      <hr>
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                              <div class="left-area">
                                <h4 class="heading">Footer Address *</h4>
                                <p class="sub-heading">(In Any Language)</p>
                              </div>
                            </div>
                            <div class="col-lg-7">
                              <textarea class="input-field"  name="lang908" required=""> {{ isset($lang->lang908) ? $lang->lang908 : 'Footer Address' }} </textarea>
                            </div>
                          </div>
 ...
 {{-- USER PANEL STARTS --}}
                      ...
                      <hr>
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                              <div class="left-area">
                                  <h4 class="heading">Affiliate Tree *</h4>
                                  <p class="sub-heading">(In Any Language)</p>
                              </div>
                            </div>
                            <div class="col-lg-7">
                              <input type="text" class="input-field" name="lang824" placeholder="Affiliate Tree" required="" value="{{ isset($lang->lang824) ? $lang->lang824 : 'Affiliate Tree' }}">
                            </div>
                          </div>
                          ...
                          <div class="row">
                            <div class="col-lg-4">
                              <div class="left-area">
                                  <h4 class="heading">SP Transfer *</h4>
                                  <p class="sub-heading">(In Any Language)</p>
                              </div>
                            </div>
                            <div class="col-lg-7">
                              <input type="text" class="input-field" name="lang825" placeholder="SP Transfer" required="" value="{{ isset($lang->lang825) ? $lang->lang825 : 'SP Transfer' }}">
                            </div>
                          </div>
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                              <div class="left-area">
                                  <h4 class="heading">Point Logs *</h4>
                                  <p class="sub-heading">(In Any Language)</p>
                              </div>
                            </div>
                            <div class="col-lg-7">
                              <input type="text" class="input-field" name="lang826" placeholder="Point Logs" required="" value="{{ isset($lang->lang826) ? $lang->lang826 : 'Point Logs' }}">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                              <div class="left-area">
                                  <h4 class="heading">KOL Bonus *</h4>
                                  <p class="sub-heading">(In Any Language)</p>
                              </div>
                            </div>
                            <div class="col-lg-7">
                              <input type="text" class="input-field" name="lang918" placeholder="KOL Bonus" required="" value="{{ isset($lang->lang918) ? $lang->lang918 : 'KOL Bonus'}}">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                              <div class="left-area">
                                  <h4 class="heading">Upgrade Membership *</h4>
                                  <p class="sub-heading">(In Any Language)</p>
                              </div>
                            </div>
                            <div class="col-lg-7">
                              <input type="text" class="input-field" name="lang827" placeholder="Upgrade Membership" required="" value="{{ isset($lang->lang827) ? $lang->lang827 : 'Upgrade Membership' }}">
                            </div>
                          </div>
                      ...
                      <hr>
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                              <div class="left-area">
                                <h4 class="heading">Received *</h4>
                                <p class="sub-heading">(In Any Language)</p>
                              </div>
                            </div>
                            <div class="col-lg-7">
                              <input type="text" class="input-field" name="lang909" placeholder="Received" required=""
                                    value="{{ isset($lang->lang909) ? $lang->lang909 : 'Received' }}">
                            </div>
                          </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-7">
                              <input type="text" class="input-field" name="lang870" placeholder="Order Total" required="" value="{{ isset($lang->lang870) ? $lang->lang870 : 'Order Total'}}">
                            </div>
                          </div>
                          ...
                          <div class="row">
                            ...
                            <div class="col-lg-7">
                              <input type="text" class="input-field" name="lang871" placeholder="VAT" required="" value="{{ isset($lang->lang871) ? $lang->lang871 : 'VAT'}}">
                            </div>
                          </div>
                          ...
                          <div class="row">
                            ...
                            <div class="col-lg-7">
                              <input type="text" class="input-field" name="lang872" placeholder="Discount" required="" value="{{ isset($lang->lang872) ? $lang->lang872 : 'Company Discount'}}">
                            </div>
                          </div>
                          ...
                          <div class="row">
                            ...
                            <div class="col-lg-7">
                              <input type="text" class="input-field" name="lang873" placeholder="Shipping Cost" required="" value="{{ isset($lang->lang873) ? $lang->lang873 : 'Shipping Cost'}}">
                            </div>
                          </div>
                          ...
                          <div class="row">
                            ...
                            <div class="col-lg-7">
                              <input type="text" class="input-field" name="lang874" placeholder="Final Price before SP" required="" value="{{ isset($lang->lang874) ? $lang->lang874 : 'Final Price before SP'}}">
                            </div>
                          </div>
                          ...
                          <div class="row">
                            ...
                            <div class="col-lg-7">
                              <input type="text" class="input-field" name="lang875" placeholder="Shopping Point" required="" value="{{ isset($lang->lang875) ? $lang->lang875 : 'Shopping Point'}}">
                            </div>
                          </div>
                          ...
                          <div class="row">
                            ...
                            <div class="col-lg-7">
                              <input type="text" class="input-field" name="lang876" placeholder="Final Price after SP" required="" value="{{ isset($lang->lang876) ? $lang->lang876 : 'Final Price after SP'}}">
                            </div>
                          </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-7">
                              <input type="text" class="input-field" name="lang882" placeholder="Shopping Point" required="" value="{{ isset($lang->lang882) ? $lang->lang882 : 'Shopping Point' }}">
                            </div>
                          </div>
                          ...
                          <div class="row">
                            ...
                            <div class="col-lg-7">
                              <input type="text" class="input-field" name="lang883" placeholder="Final Price after SP" required="" value="{{ isset($lang->lang883) ? $lang->lang883 : 'Final Price after SP' }}">
                            </div>
                          </div>
                          ...
                          <div class="row">
                            ...
                            <div class="col-lg-7">
                              <input type="text" class="input-field" name="lang887"
                                placeholder="Company Discount" required=""
                                value="{{ isset($lang->lang887) ? $lang->lang887 : 'Company Discount' }}">
                            </div>
                          </div>
                          ...
                          <div class="row">
                            <div class="col-lg-4">
                              <div class="left-area">
                                  <h4 class="heading">Shop Discount *</h4>
                                  <p class="sub-heading">(In Any Language)</p>
                              </div>
                            </div>
                            <div class="col-lg-7">
                              <input type="text" class="input-field" name="lang888"
                                placeholder="Shop Discount" required=""
                                value="{{ isset($lang->lang888) ? $lang->lang888 : 'Shop Discount' }}">
                            </div>
                          </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-7">
                              <input type="text" class="input-field" name="lang863" placeholder="VAT" required="" value="{{ isset($lang->lang863) ? $lang->lang863 : 'VAT' }}">
                            </div>
                          </div>
                          ...
                          <div class="row">
                            <div class="col-lg-4">
                              <div class="left-area">
                                  <h4 class="heading">Delivery Code *</h4>
                                  <p class="sub-heading">(In Any Language)</p>
                              </div>
                            </div>
                            <div class="col-lg-7">
                              <input type="text" class="input-field" name="lang864" placeholder="Delivery Code" required="" value="{{ isset($lang->lang864) ? $lang->lang864 : 'Delivery Code' }}">
                            </div>
                          </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-7">
                              <input type="text" class="input-field" name="lang877" placeholder="Shipping Cost" required="" value="{{ isset($lang->lang877) ? $lang->lang877 : 'Shipping Cost' }}">
                            </div>
                          </div>
                      ...
                      <hr>
                        ...
                        <h4 class="text-center">SP TRANSFER</h4>
                      ...
                      <hr>
                        ...
                        <div class="row">
                          <div class="col-lg-4">
                            <div class="left-area">
                                <h4 class="heading">Shopping Point Transfer *</h4>
                                <p class="sub-heading">(In Any Language)</p>
                            </div>
                          </div>
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang828" placeholder="Shopping Point Transfer" required="" value="{{ isset($lang->lang828) ? $lang->lang828 : 'Shopping Point Transfer'}}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-7">
                              <input type="text" class="input-field" name="lang830" placeholder="Phone number" required="" value="{{ isset($lang->lang830) ? $lang->lang830 : 'Phone number'}}">
                            </div>
                          </div>
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                              <div class="left-area">
                                  <h4 class="heading">Input your phone number *</h4>
                                  <p class="sub-heading">(In Any Language)</p>
                              </div>
                            </div>
                            <div class="col-lg-7">
                              <input type="text" class="input-field" name="lang829" placeholder="Input your phone number" required="" value="{{ isset($lang->lang829) ? $lang->lang829 : 'Input your phone number'}}">
                            </div>
                          </div>
                          ...
                          <div class="row">
                            ...
                            <div class="col-lg-7">
                              <input type="text" class="input-field" name="lang831" placeholder="Search" required="" value="{{ isset($lang->lang831) ? $lang->lang831 : 'Search'}}">
                            </div>
                          </div>
                          ...
                          <div class="row">
                            ...
                            <div class="col-lg-7">
                              <input type="text" class="input-field" name="lang832" placeholder="Total" required="" value="{{ isset($lang->lang832) ? $lang->lang832 : 'Total'}}">
                            </div>
                          </div>
                          ...
                          <div class="row">
                            <div class="col-lg-4">
                              <div class="left-area">
                                  <h4 class="heading">Total of shopping point *</h4>
                                  <p class="sub-heading">(In Any Language)</p>
                              </div>
                            </div>
                            <div class="col-lg-7">
                              <input type="text" class="input-field" name="lang833" placeholder="Total of shopping point" required="" value="{{ isset($lang->lang833) ? $lang->lang833 : 'Total of shopping point'}}">
                            </div>
                          </div>
                          ...
                          <div class="row">
                            <div class="col-lg-4">
                              <div class="left-area">
                                  <h4 class="heading">Transfer amount *</h4>
                                  <p class="sub-heading">(In Any Language)</p>
                              </div>
                            </div>
                            <div class="col-lg-7">
                              <input type="text" class="input-field" name="lang834" placeholder="Transfer amount" required="" value="{{ isset($lang->lang834) ? $lang->lang834 : 'Transfer amount'}}">
                            </div>
                          </div>
                          ...
                          <div class="row">
                            <div class="col-lg-4">
                              <div class="left-area">
                                  <h4 class="heading">Amount of shopping point transfer *</h4>
                                  <p class="sub-heading">(In Any Language)</p>
                              </div>
                            </div>
                            <div class="col-lg-7">
                              <input type="text" class="input-field" name="lang835" placeholder="Amount of shopping point transfer" required="" value="{{ isset($lang->lang835) ? $lang->lang835 : 'Amount of shopping point transfer'}}">
                            </div>
                          </div>
                          ...
                          <div class="row">
                            ...
                            <div class="col-lg-7">
                              <input type="text" class="input-field" name="lang836" placeholder="Remain" required="" value="{{ isset($lang->lang836) ? $lang->lang836 : 'Remain'}}">
                            </div>
                          </div>
                          ...
                          <div class="row">
                            <div class="col-lg-4">
                              <div class="left-area">
                                  <h4 class="heading">Shopping point Remaining *</h4>
                                  <p class="sub-heading">(In Any Language)</p>
                              </div>
                            </div>
                            <div class="col-lg-7">
                              <input type="text" class="input-field" name="lang837" placeholder="Shopping point Remaining" required="" value="{{ isset($lang->lang837) ? $lang->lang837 : 'Shopping point Remaining'}}">
                            </div>
                          </div>
                          ...
                          <div class="row">
                            <div class="col-lg-4">
                              <div class="left-area">
                                  <h4 class="heading">Transfer *</h4>
                                  <p class="sub-heading">(In Any Language)</p>
                              </div>
                            </div>
                            <div class="col-lg-7">
                              <input type="text" class="input-field" name="lang838" placeholder="Transfer" required="" value="{{ isset($lang->lang838) ? $lang->lang838 : 'Transfer'}}">
                            </div>
                          </div>
                      ...
                      <hr>
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                              <div class="left-area">
                                  <h4 class="heading">Inbox *</h4>
                                  <p class="sub-heading">(In Any Language)</p>
                              </div>
                            </div>
                            <div class="col-lg-7">
                              <input type="text" class="input-field" name="lang890"
                                placeholder="Inbox" required=""
                                value="{{ isset($lang->lang890) ? $lang->lang890 : 'Inbox' }}">
                            </div>
                          </div>
                      ...
                      <hr>
                        ...
                        <h4 class="text-center">POINT LOGS</h4>
                      ...
                      <hr>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang839" placeholder="From" required="" value="{{ isset($lang->lang839) ? $lang->lang839 : 'From'}}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-7">
                              <input type="text" class="input-field" name="lang840" placeholder="To" required="" value="{{ isset($lang->lang840) ? $lang->lang840 : 'To'}}">
                            </div>
                          </div>
                          ...
                          <div class="row">
                            ...
                            <div class="col-lg-7">
                              <input type="text" class="input-field" name="lang841" placeholder="Type" required="" value="{{ isset($lang->lang841) ? $lang->lang841 : 'Type'}}">
                            </div>
                          </div>
                          ...
                          <div class="row">
                            <div class="col-lg-4">
                              <div class="left-area">
                                  <h4 class="heading">Find *</h4>
                                  <p class="sub-heading">(In Any Language)</p>
                              </div>
                            </div>
                            <div class="col-lg-7">
                              <input type="text" class="input-field" name="lang842" placeholder="Find" required="" value="{{ isset($lang->lang842) ? $lang->lang842 : 'Find'}}">
                            </div>
                          </div>
                          ...
                          <div class="row">
                            ...
                            <div class="col-lg-7">
                              <input type="text" class="input-field" name="lang843" placeholder="Date" required="" value="{{ isset($lang->lang843) ? $lang->lang843 : 'Date'}}">
                            </div>
                          </div>
                          ...
                          <div class="row">
                            ...
                            <div class="col-lg-7">
                              <input type="text" class="input-field" name="lang844" placeholder="Reward Point" required="" value="{{ isset($lang->lang844) ? $lang->lang844 : 'Reward Point'}}">
                            </div>
                          </div>
                          ...
                          <div class="row">
                            ...
                            <div class="col-lg-7">
                              <input type="text" class="input-field" name="lang845" placeholder="Shopping Point" required="" value="{{ isset($lang->lang845) ? $lang->lang845 : 'Shopping Point'}}">
                            </div>
                          </div>
                          ...
                          <div class="row">
                            ...
                            <div class="col-lg-7">
                              <input type="text" class="input-field" name="lang846" placeholder="Remarks" required="" value="{{ isset($lang->lang846) ? $lang->lang846 : 'Remarks'}}">
                            </div>
                          </div>
                          ...
                          <div class="row">
                            ...
                            <div class="col-lg-7">
                              <input type="text" class="input-field" name="lang847" placeholder="Options" required="" value="{{ isset($lang->lang847) ? $lang->lang847 : 'Options'}}">
                            </div>
                          </div>
                          ...
                          <div class="row">
                            ...
                            <div class="col-lg-7">
                              <input type="text" class="input-field" name="lang848" placeholder="All" required="" value="{{ isset($lang->lang848) ? $lang->lang848 : 'All'}}">
                            </div>
                          </div>
                          ...
                          <div class="row">
                            <div class="col-lg-4">
                              <div class="left-area">
                                  <h4 class="heading">Daily Convert *</h4>
                                  <p class="sub-heading">(In Any Language)</p>
                              </div>
                            </div>
                            <div class="col-lg-7">
                              <input type="text" class="input-field" name="lang849" placeholder="Daily Convert" required="" value="{{ isset($lang->lang849) ? $lang->lang849 : 'Daily Convert'}}">
                            </div>
                          </div>
                          ...
                          <div class="row">
                            ...
                            <div class="col-lg-7">
                              <input type="text" class="input-field" name="lang850" placeholder="Rebate Bonus" required="" value="{{ isset($lang->lang850) ? $lang->lang850 : 'Rebate Bonus'}}">
                            </div>
                          </div>
                          ...
                          <div class="row">
                            <div class="col-lg-4">
                              <div class="left-area">
                                  <h4 class="heading">Use Shopping *</h4>
                                  <p class="sub-heading">(In Any Language)</p>
                              </div>
                            </div>
                            <div class="col-lg-7">
                              <input type="text" class="input-field" name="lang851" placeholder="Use Shopping" required="" value="{{ isset($lang->lang851) ? $lang->lang851 : 'Use Shopping'}}">
                            </div>
                          </div>
                          ...
                          <div class="row">
                            ...
                            <div class="col-lg-7">
                              <input type="text" class="input-field" name="lang852" placeholder="Affiliate Bonus" required="" value="{{ isset($lang->lang852) ? $lang->lang852 : 'Affiliate Bonus'}}">
                            </div>
                          </div>
                          ...
                          <div class="row">
                            <div class="col-lg-4">
                              <div class="left-area">
                                  <h4 class="heading">Merchant Sales Bonus *</h4>
                                  <p class="sub-heading">(In Any Language)</p>
                              </div>
                            </div>
                            <div class="col-lg-7">
                              <input type="text" class="input-field" name="lang853" placeholder="Merchant Sales Bonus" required="" value="{{ isset($lang->lang853) ? $lang->lang853 : 'Merchant Sales Bonus'}}">
                            </div>
                          </div>
                          ...
                          <div class="row">
                            <div class="col-lg-4">
                              <div class="left-area">
                                  <h4 class="heading">Order Declined *</h4>
                                  <p class="sub-heading">(In Any Language)</p>
                              </div>
                            </div>
                            <div class="col-lg-7">
                              <input type="text" class="input-field" name="lang854" placeholder="Order Declined" required="" value="{{ isset($lang->lang854) ? $lang->lang854 : 'Order Declined'}}">
                            </div>
                          </div>
                          ...
                          <div class="row">
                            <div class="col-lg-4">
                              <div class="left-area">
                                  <h4 class="heading">Global Transfer *</h4>
                                  <p class="sub-heading">(In Any Language)</p>
                              </div>
                            </div>
                            <div class="col-lg-7">
                              <input type="text" class="input-field" name="lang855" placeholder="Global Transfer" required="" value="{{ isset($lang->lang855) ? $lang->lang855 : 'Global Transfer'}}">
                            </div>
                          </div>
                          ...
                          <div class="row">
                            <div class="col-lg-4">
                              <div class="left-area">
                                  <h4 class="heading">Order Completed *</h4>
                                  <p class="sub-heading">(In Any Language)</p>
                              </div>
                            </div>
                            <div class="col-lg-7">
                              <input type="text" class="input-field" name="lang856" placeholder="Order Completed" required="" value="{{ isset($lang->lang856) ? $lang->lang856 : 'Order Completed'}}">
                            </div>
                          </div>
                          ...
                          <div class="row">
                            <div class="col-lg-4">
                              <div class="left-area">
                                  <h4 class="heading">Order - Shop Declined *</h4>
                                  <p class="sub-heading">(In Any Language)</p>
                              </div>
                            </div>
                            <div class="col-lg-7">
                              <input type="text" class="input-field" name="lang857" placeholder="Order - Shop Declined" required="" value="{{ isset($lang->lang857) ? $lang->lang857 : 'Order - Shop Declined'}}">
                            </div>
                          </div>
                          ...
                          <div class="row">
                            <div class="col-lg-4">
                              <div class="left-area">
                                <h4 class="heading">Buying Package Bonus *</h4>
                                <p class="sub-heading">(In Any Language)</p>
                              </div>
                            </div>
                            <div class="col-lg-7">
                              <input type="text" class="input-field" name="lang912" placeholder="Buying Package Bonus" required=""
                                    value="{{ isset($lang->lang912) ? $lang->lang912 : 'Buying Package Bonus' }}">
                            </div>
                          </div>
                          ...
                          <div class="row">
                            <div class="col-lg-4">
                              <div class="left-area">
                                <h4 class="heading">KOL Consumer Bonus *</h4>
                                <p class="sub-heading">(In Any Language)</p>
                              </div>
                            </div>
                            <div class="col-lg-7">
                              <input type="text" class="input-field" name="lang913" placeholder="KOL Consumer Bonus" required=""
                                    value="{{ isset($lang->lang913) ? $lang->lang913 : 'KOL Consumer Bonus' }}">
                            </div>
                          </div>
                          ...
                          <div class="row">
                            <div class="col-lg-4">
                              <div class="left-area">
                                <h4 class="heading">KOL Affiliate Bonus *</h4>
                                <p class="sub-heading">(In Any Language)</p>
                              </div>
                            </div>
                            <div class="col-lg-7">
                              <input type="text" class="input-field" name="lang916" placeholder="KOL Affiliate Bonus" required=""
                                    value="{{ isset($lang->lang916) ? $lang->lang916 : 'KOL Affiliate Bonus' }}">
                            </div>
                          </div>
                          ...
                          <div class="row">
                            <div class="col-lg-4">
                              <div class="left-area">
                                <h4 class="heading">Ratio *</h4>
                                <p class="sub-heading">(In Any Language)</p>
                              </div>
                            </div>
                            <div class="col-lg-7">
                              <input type="text" class="input-field" name="lang914" placeholder="Ratio" required=""
                                    value="{{ isset($lang->lang914) ? $lang->lang914 : 'Ratio' }}">
                            </div>
                          </div>
                          ...
                          <div class="row">
                            <div class="col-lg-4">
                              <div class="left-area">
                                <h4 class="heading">Amount Bonus *</h4>
                                <p class="sub-heading">(In Any Language)</p>
                              </div>
                            </div>
                            <div class="col-lg-7">
                              <input type="text" class="input-field" name="lang915" placeholder="Amount Bonus" required=""
                                    value="{{ isset($lang->lang915) ? $lang->lang915 : 'Amount Bonus' }}">
                            </div>
                          </div>
                      ...
                      <hr>
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                              <div class="left-area">
                                  <h4 class="heading">Current Plan End At *</h4>
                                  <p class="sub-heading">(In Any Language)</p>
                              </div>
                            </div>
                            <div class="col-lg-7">
                              <input type="text" class="input-field" name="lang884"
                                placeholder="Current Plan End At" required=""
                                value="{{ isset($lang->lang884) ? $lang->lang884 : 'Current Plan End At' }}">
                            </div>
                          </div>
                          ...
                          <div class="row">
                            <div class="col-lg-4">
                              <div class="left-area">
                                  <h4 class="heading">Estimate New Plan End At *</h4>
                                  <p class="sub-heading">(In Any Language)</p>
                              </div>
                            </div>
                            <div class="col-lg-7">
                              <input type="text" class="input-field" name="lang885"
                                placeholder="Estimate New Plan End At" required=""
                                value="{{ isset($lang->lang885) ? $lang->lang885 : 'Estimate New Plan End At' }}">
                            </div>
                          </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-7">
                              <input type="text" class="input-field" name="lang886"
                                placeholder="Renew" required=""
                                value="{{ isset($lang->lang886) ? $lang->lang886 : 'Renew' }}">
                            </div>
                          </div>
 ...
 {{-- VENDOR PANEL STARTS --}}
                      ...
                      <div class="row">
                        <div class="col-lg-4">
                          <div class="left-area">
                            <h4 class="heading">Yearly Plan *</h4>
                            <p class="sub-heading">(In Any Language)</p>
                          </div>
                        </div>
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang910" placeholder="Yearly Plan" required=""
                                value="{{ isset($lang->lang910) ? $lang->lang910 : 'Yearly Plan' }}">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        <div class="col-lg-4">
                          <div class="left-area">
                            <h4 class="heading">Shop Experience *</h4>
                            <p class="sub-heading">(In Any Language)</p>
                          </div>
                        </div>
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang911" placeholder="Shop Experience" required=""
                                value="{{ isset($lang->lang911) ? $lang->lang911 : 'Shop Experience' }}">
                        </div>
                      </div>
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                              <div class="left-area">
                                <h4 class="heading">Orders fail *</h4>
                                <p class="sub-heading">(In Any Language)</p>
                              </div>
                            </div>
                            <div class="col-lg-7">
                              <input type="text" class="input-field" name="lang917" placeholder="Orders fail" required="" value="{{  $lang->lang917 ??= '' }}">
                            </div>
                        </div>
                      ...
                      <hr>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-7">
                              <input type="text" class="input-field" name="lang858" placeholder="Payment Date" required="" value="{{ isset($lang->lang858) ? $lang->lang858 : 'Payment Date' }}">
                            </div>
                          </div>
                          ...
                          <div class="row">
                            <div class="col-lg-4">
                              <div class="left-area">
                                  <h4 class="heading">Payment Amount *</h4>
                                  <p class="sub-heading">(In Any Language)</p>
                              </div>
                            </div>
                            <div class="col-lg-7">
                              <input type="text" class="input-field" name="lang859" placeholder="Payment Amount" required="" value="{{ isset($lang->lang859) ? $lang->lang859 : 'Payment Amount' }}">
                            </div>
                          </div>
                          ...
                          <div class="row">
                            ...
                            <div class="col-lg-7">
                              <input type="text" class="input-field" name="lang860" placeholder="Delivery Code" required="" value="{{ isset($lang->lang860) ? $lang->lang860 : 'Delivery Code' }}">
                            </div>
                          </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-7">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-7">
                              <input type="text" class="input-field" name="lang865" placeholder="Delivery Partner" required="" value="{{ isset($lang->lang865) ? $lang->lang865 : 'Delivery Partner' }}">
                            </div>
                          </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-7">
                              <input type="text" class="input-field" name="lang866" placeholder="Delivery Code" required="" value="{{ isset($lang->lang866) ? $lang->lang866 : 'Delivery Code' }}">
                            </div>
                          </div>
                          ...
                          <div class="row">
                            ...
                            <div class="col-lg-7">
                              <input type="text" class="input-field" name="lang867" placeholder="Shipping Cost" required="" value="{{ isset($lang->lang867) ? $lang->lang867 : 'Shipping Cost' }}">
                            </div>
                          </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-7">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-7">
                              <input type="text" class="input-field" name="lang878" placeholder="Shipping Cost" required="" value="{{ isset($lang->lang878) ? $lang->lang878 : 'Shipping Cost' }}">
                            </div>
                          </div>
                          ...
                          <div class="row">
                            ...
                            <div class="col-lg-7">
                              <input type="text" class="input-field" name="lang879" placeholder="Final Price before SP" required="" value="{{ isset($lang->lang879) ? $lang->lang879 : 'Final Price before SP' }}">
                            </div>
                          </div>
                          ...
                          <div class="row">
                            ...
                            <div class="col-lg-7">
                              <input type="text" class="input-field" name="lang880" placeholder="Shopping Point" required="" value="{{ isset($lang->lang880) ? $lang->lang880 : 'Shopping Point' }}">
                            </div>
                          </div>
                          ...
                          <div class="row">
                            ...
                            <div class="col-lg-7">
                              <input type="text" class="input-field" name="lang881" placeholder="Final Price after SP" required="" value="{{ isset($lang->lang881) ? $lang->lang881 : 'Final Price after SP' }}">
                            </div>
                          </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-7">
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                              <div class="left-area">
                                  <h4 class="heading">Product Weight *</h4>
                                  <p class="sub-heading">(In Any Language)</p>
                              </div>
                            </div>
                            <div class="col-lg-7">
                              <input type="text" class="input-field" name="lang861" placeholder="Product Weight" required="" value="{{ isset($lang->lang861) ? $lang->lang861 : 'Product Weight' }}">
                            </div>
                          </div>
                          ...
                          <div class="row">
                            ...
                            <div class="col-lg-7">
                              <input type="text" class="input-field" name="lang862" placeholder="Gram" required="" value="{{ isset($lang->lang862) ? $lang->lang862 : 'Gram' }}">
                            </div>
                          </div>
                   ...
                   <hr>
                      ...
                      <hr>
                        ...
                        <div class="row">
                          <div class="col-lg-4">
                            <div class="left-area">
                                <h4 class="heading">Prefered Size: (1350x540) or Square Sized Image *</h4>
                                <p class="sub-heading">(In Any Language)</p>
                            </div>
                          </div>
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang521" placeholder="Prefered Size: (1350x540) or Square Sized Image" required="" value="{{ $lang->lang521 }}">
                          </div>
                        </div>
