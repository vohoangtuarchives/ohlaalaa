                    ...
                    <div class="product-description">
                      ...
                      <form id="geniusformdata" action="{{route('admin-cat-update',$data->id)}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-7">
                              <input type="number" class="input-field" name="handling_fee" required="" value="{{$data->handling_fee}}">
                            </div>
                          </div>
                          ...
                          <div class="col-lg-7">
                            <div class="img-upload">
                                <div id="image-preview" class="img-preview"
                                    ...
                                    style="background: url({{ $data->show_photo() }});"
                                    >
                          ...
                          <div class="col-lg-7">
                            <div class="img-upload">
                              <div id="image-preview" class="img-preview"
                                ...
                                style="background: url({{ $data->show_image() }});"
                                >
