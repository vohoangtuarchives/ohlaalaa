                    ...
                    <div class="product-description">
                      <div class="body-area">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-3">
                              <div class="left-area">
                                  <h4 class="heading">{{ __('Send Email When Subscription Remain') }} (days) *
                                    </h4>
                              </div>
                            </div>
                            <div class="col-lg-6">
                              <input type="number" class="input-field" placeholder="{{ __('Send Email When Subscription Remain') }}" name="subs_notify_remain_days" value="{{ $gs->subs_notify_remain_days }}" required="" min="0">
                            </div>
                          </div>
