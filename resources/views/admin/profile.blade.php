...
@section('content')
                        ...
                        @include('includes.admin.form-both')
                                                ...
                                                {{-- <div class="row">
													...
													<div class="col-lg-7">
														<input type="text" class="input-field" name="api_token" id="api-token" placeholder="api_token" required="" value="{{$data->api_token}}">
                                                    </div>
												</div> --}}
											...
											@endif
						                        ...
						                        <div class="row">
						                          ...
						                          <div class="col-lg-7">
                                                    ...
                                                    {{-- <button class="addProductSubmit-btn" id="btnGetToken" type="button">Get Token</button> --}}
						                          </div>
						                        </div>
