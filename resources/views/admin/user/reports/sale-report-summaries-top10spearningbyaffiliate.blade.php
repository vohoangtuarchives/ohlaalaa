                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                        ...
                                        <ul class="links">
                                            ...
                                            <li>
                                                <a href="{{route('admin-user-report-sale-report-summaries-top10spearningbyaffiliate')}}">{{ __('Sale Report Summaries Top 10 SP Earning By Affiliate') }}</a>
                                            </li>
                                        </ul>
                                </div>
                            </div>
...
<script type="text/javascript">
    ...
    var table = $('#geniustable').DataTable({
        ...
        serverSide: true,
        pageLength: 50,
        ajax: '{{ route('admin-user-report-sale-report-summaries-top10spearningbyaffiliate-datatables',[\Carbon\Carbon::now()->format('Y-m-d'),\Carbon\Carbon::now()->format('Y-m-d')]) }}',
        columns: [
                { data: 'customer_name', name: 'customer_name'},
                { data: 'ranking', name: 'ranking'},
                { data: 'created_at', name: 'created_at'},
                { data: 'l1_count', name: 'l1_count'},
                { data: 'total_shopping_point', name: 'total_shopping_point'},
    ...
    $("#add-find" ).on('click' , function(e){
        ...
        var url = mainurl+'/admin/users/reports/salereport/summaries/top10spearningbyaffiliate/datatables/'+sf+'/'+st;
        console.log('url',url);
    ...
    $("#export-excel" ).on('click' , function(e){
        ...
        var st = get_date_string($('#to').val());
        // var status = $('#status').val();
        var url = mainurl+'/admin/users/reports/salereport/summaries/top10spearningbyaffiliate/export/'+sf+'/'+st;
