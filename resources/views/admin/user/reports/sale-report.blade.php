                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                        ...
                                        <ul class="links">
                                            ...
                                            <li>
                                                <a href="{{route('admin-user-report-sale-report')}}">{{ __('Sale Report Customer') }}</a>
                                            </li>
                                        </ul>
                                </div>
                            </div>
...
<script type="text/javascript">
    ...
    var table = $('#geniustable').DataTable({
        ...
        serverSide: true,
        pageLength: 50,
        ajax: '{{ route('admin-user-report-sale-report-datatables',[\Carbon\Carbon::now()->format('Y-m-d'),\Carbon\Carbon::now()->format('Y-m-d')]) }}',
        columns: [
    ...
    $("#add-find" ).on('click' , function(e){
        ...
        var url = mainurl+'/admin/users/reports/salereport/datatables/'+sf+'/'+st;
        console.log('url',url);
    ...
    $("#export-excel" ).on('click' , function(e){
        ...
        var st = get_date_string($('#to').val());
        // var status = $('#status').val();
        var url = mainurl+'/admin/users/reports/salereport/export/'+sf+'/'+st;
