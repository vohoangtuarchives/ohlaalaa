...
@section('content')
                                            ...
                                            <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="user-image">
                                                            ...
                                                            <img src="{{ $data->show_photo()}}" alt="No Image">
                                                            @endif
                                                    ...
                                                    <div class="table-responsive show-table">
                                                        ...
                                                        <tr>
                                                            <th>{{ __("Address") }}</th>
                                                            <td>{{$data->address}}{{ isset($data->province) ? ", ". $data->province->name : "" }}</td>
                                                        </tr>
                                                    ...
                                                    <table class="table">
                                                            <tr>
                                                                <th>{{ __("Type") }}</th>
                                                                <td>{{$data->is_vendor == 2 ? 'Merchant' : 'User'}}</td>
                                                            </tr>
                                                            <tr>
                                                                <th>{{ __("Rank") }}</th>
                                                            ...
                                                            <tr>
                                                                <th>{{ __("RP") }}</th>
                                                                <td>{{ number_format($data->reward_point)}}</td>
                                                            </tr>
                                                            <tr>
                                                                <th>{{ __("SP") }}</th>
                                                                <td>{{ number_format($data->shopping_point)}}</td>
                                                            </tr>
                                                            <tr>
                                                                <th>{{ __("Aff. code") }}</th>
                                                                <td>{{$data->affilate_code}}</td>
                                                            </tr>
                                                            <tr>
                                                                <th>{{ __("Referral") }}</th>
            ...
            <td><a href="{{ route('admin-order-invoice',$order->id) }}">{{sprintf("%'.08d", $order->id)}}</a></td>
                                                                            ...
                                                                            <td>{{ $order->currency_sign . round($order->pay_amount1 * $order->currency_value , 2) }}</td>
                                                                            <td>{{ $order->status }}</td>
                                                                            <td>
