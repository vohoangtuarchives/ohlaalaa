                      ...
                      <form id="geniusform" action="{{route('admin-role-update',$data->id)}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-4 d-flex justify-content-between">
                              ...
                              <label class="switch">
                                <input type="checkbox" name="section[]" value="reports" {{ $data->sectionCheck('reports') ? 'checked' : '' }}>
                                <span class="slider round"></span>
                              </label>
                            </div>
                            <div class="col-lg-2"></div>
                            <div class="col-lg-4 d-flex justify-content-between">
                            <label class="control-label">{{ __('KOL Bonus') }} *</label>
                              <label class="switch">
                                <input type="checkbox" name="section[]" value="kolbonus" {{ $data->sectionCheck('kolbonus') ? 'checked' : '' }}>
                                <span class="slider round"></span>
                              </label>
                            </div>
                        </div>
                        ...
                        <div class="row justify-content-center" >
                          <div class="col-lg-4 d-flex justify-content-between">
                          <label class="control-label">{{ __('External Report') }} *</label>
                            <label class="switch">
                              <input type="checkbox" name="section[]" value="externalreport" {{ $data->sectionCheck('externalreport') ? 'checked' : '' }}>
                              <span class="slider round"></span>
                            </label>
                          </div>
